...
// Travel Content Component
const TravelContent = ({ selectedDog }) => {
  ...
  const handleToggleItem = async (checklistId, itemIndex, checked) => {
    try {
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => 
                            handleToggleItem(checklist.checklist_id, itemIndex, checked)
                          }
...
export const TravelPlanner = ({ user }) => {
  return (
    <AppLayout user={user}>
      {({ selectedDog }) => <TravelContent selectedDog={selectedDog} />}
    </AppLayout>
  );
};
