...
export const BehaviorTracker = ({ user }) => {
  ...
  const handleAddLog = async (dogId) => {
  ...
  const handleDeleteLog = async (logId, dogId) => {
    try {
              ...
              <Dialog open={addLogOpen} onOpenChange={setAddLogOpen}>
                ...
                <DialogContent className="max-w-lg">
                  ...
                  <div className="space-y-4 mt-4">
                    ...
                    <Button 
                      onClick={() => handleAddLog(selectedDog.dog_id)}
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start gap-4">
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => handleDeleteLog(log.log_id, selectedDog.dog_id)}
